...
LABEL_TO_TASK_MAP_ORIG = {
    ...
    "basic_skills_coding_rc_5shot": (
        OEEvalTask,
        {"dataset_path": "basic_skills_coding", "dataset_name": "rc_5shot", "metric_type": "len_norm"},
    ),
    ...
    "basic_skills_pattern_rc_5shot": (
        OEEvalTask,
        {"dataset_path": "basic_skills_pattern", "dataset_name": "rc_5shot", "metric_type": "len_norm"},
    ),
